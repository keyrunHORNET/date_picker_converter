...
public class DatePickerDialog extends DialogFragment implements View.OnClickListener, DatePickerController {
        ...
        private void adjustDayInMonthIfNeeded(Model calendar) {
            ...
            int daysInMonth = new DateConverter().noOfDaysInMonth(calendar.getYear(),calendar.getMonth());
            if (day > daysInMonth) {
        ...
        public void onDayOfMonthSelected(int year, int month, int day) {
            Log.d("KG:onDayOfMonthSelected","year:"+year+" MONTH:"+month+" DAY:"+day);
            ...
            Log.d("KG:onDayOfMonthSelected","mCalander: year:"+year+" MONTH:"+mCalendar.getMonth()+" DAY:"+mCalendar.getDay());
        ...
        private boolean isSelectable(int year, int month, int day) {
            for (Calendar c : selectableDays) {
                Log.d("KG: isSelectable:","SelectableDays: "+selectableDays);
        ...
        private boolean isBeforeMin(int year, int month, int day) {
            ...
            if (year < mMinDate.get(Calendar.YEAR)) {
                Log.d("KG: minDate:","True: "+mMinDate.get(Calendar.YEAR));
                return true;
            } else if (year > mMinDate.get(Calendar.YEAR)) {
                Log.d("KG: minDate:","False: "+mMinDate.get(Calendar.YEAR));
                return false;
            }

            if (month < mMinDate.get(Calendar.MONTH)) {
                Log.d("KG: minDate:","True: "+mMinDate.get(Calendar.MONTH));
                return true;
            } else if (month > mMinDate.get(Calendar.MONTH)) {
                Log.d("KG: minDate:","False: "+mMinDate.get(Calendar.MONTH));
                return false;
            }

            if (day < mMinDate.get(Calendar.DAY_OF_MONTH)) {
                Log.d("KG: minDate:","True: "+mMinDate.get(Calendar.DAY_OF_MONTH));
                return true;
            } else {
                Log.d("KG: minDate:","False: "+mMinDate.get(Calendar.DAY_OF_MONTH));
                return false;
            }
        }
        ...
        private boolean isAfterMax(int year, int month, int day) {
            ...
            if (year > mMaxDate.get(Calendar.YEAR)) {
                //Log.d("KG: maxDate:","True: "+mMaxDate.get(Calendar.YEAR));
                return true;
            } else if (year < mMaxDate.get(Calendar.YEAR)) {
                //Log.d("KG: maxDate:","False: "+mMaxDate.get(Calendar.YEAR));
                return false;
            }

            if (month > mMaxDate.get(Calendar.MONTH)) {
                //Log.d("KG: maxDate:","True: "+mMaxDate.get(Calendar.MONTH));
                return true;
            } else if (month < mMaxDate.get(Calendar.MONTH)) {
                //Log.d("KG: maxDate:","False: "+mMaxDate.get(Calendar.MONTH));
                return false;
            }

            if (day > mMaxDate.get(Calendar.DAY_OF_MONTH)) {
                //Log.d("KG: maxDate:","True: "+mMaxDate.get(Calendar.DAY_OF_MONTH));
                return true;
            } else {
                //Log.d("KG: maxDate:","False: "+mMaxDate.get(Calendar.DAY_OF_MONTH));
                return false;
            }
        }
